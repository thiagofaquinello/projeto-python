...
def estoque_suficiente(resultado_nome,quantidade):
...
def remover_estoque(resultado_nome, quantidade):
    ...
    if estoque_suficiente(resultado_nome,quantidade):
...
if resultado_nome is None:
    ...
    exit()
quantidade = int(input("Digite a quantidade removida ao estoque: "))
